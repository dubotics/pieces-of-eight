...
public class MotorCalculator2 {
	...
	public MotorCalculator2(Packet packet) {
		this.packet = packet;
	...
	public void computeMotors() {
		...
		//Fl, FR, BR, BL motors respectively
		//Wiring is done so that all postive forward gives a foward drive with robot
	...
	void getValues() {
		...
		packet.trigger = -trigger.getPollData(); // Right trigger is negative, so invert
